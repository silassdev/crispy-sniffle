...
?>
            ...
            <a href="<?php echo e(route('profile.edit')); ?>" class="icon-nav-item" title="Profile">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <div x-show="mobile" x-cloak x-transition class="md:hidden mobile-backdrop border-t">
    <div class="px-4 py-4 space-y-3">
      ...
      <?php else: ?>
        ...
        <a @click="mobile = false" href="<?php echo e(route('profile.edit')); ?>" class="block py-2 text-gray-700 font-medium tracking-tight">Profile</a>
