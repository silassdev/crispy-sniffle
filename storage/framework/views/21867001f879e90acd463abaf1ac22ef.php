...
<div x-data="{ open:false }"
  ...
  <div class="bg-white rounded p-6 w-full max-w-md">
    ...
    <p class="text-sm text-gray-700 mb-4">
      ...
      <!--[if BLOCK]><![endif]--><?php if($confirmAction === 'publish'): ?> publish
      <?php elseif($confirmAction === 'save-draft'): ?> save as draft
      <?php elseif($confirmAction === 'delete-post'): ?> delete this post
      <?php elseif($confirmAction === 'ban-user'): ?> ban this user
      <?php elseif($confirmAction === 'unban-user'): ?> unban this user
      <?php elseif($confirmAction === 'abandon'): ?> abandon changes
      <?php else: ?> perform this action
