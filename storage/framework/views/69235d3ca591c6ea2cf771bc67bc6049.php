...
<div class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        <div class="bg-blue-600 rounded-3xl p-12 text-center text-white shadow-2xl shadow-blue-200">
            <h2 class="text-3xl md:text-4xl font-bold mb-6 italic">Ready to Share Your Thoughts?</h2>
            <p class="text-blue-100 mb-8 max-w-2xl mx-auto">Your feedback drives our continuous improvement. Whether it's a suggestion, concern, or compliment, we want to hear from you.</p>
            <a href="<?php echo e(route('contact.show')); ?>" class="inline-block px-10 py-4 bg-white text-blue-600 font-bold rounded-xl hover:bg-blue-50 transition duration-300 shadow-lg hover:-translate-y-1 transform">Submit Feedback Now</a>
        </div>
    </div>
</div>
