    ...
    return {
      ...
      init() {
        ...
        <?php if(session('success')): ?>
          this.enqueue('Success', <?php echo json_encode(session('success')); ?>, 'success', 4000);
        <?php endif; ?>
        <?php if(session('error')): ?>
          this.enqueue('Error', <?php echo json_encode(session('error')); ?>, 'error', 5000);
        <?php endif; ?>
        <?php if(session('warning')): ?>
          this.enqueue('Warning', <?php echo json_encode(session('warning')); ?>, 'warning', 5000);
        <?php endif; ?>
        <?php if(session('info')): ?>
          this.enqueue('Info', <?php echo json_encode(session('info')); ?>, 'info', 4000);
        <?php endif; ?>
...
</script><?php /**PATH C:\xampp\htdocs\laravel-lms\resources\views/components/toast.blade.php ENDPATH**/ ?>