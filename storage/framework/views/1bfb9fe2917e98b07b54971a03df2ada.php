...
<?php $__env->startSection('title', 'Certificate Not Found'); ?>
    ...
    <div class="max-w-md w-full">
        <div class="bg-white rounded-2xl shadow-xl border border-slate-200 p-8 text-center">
            ...
            <div class="border-t border-slate-200 pt-6">
                ...
                <form action="<?php echo e(route('certificate.verify', ':placeholder')); ?>" method="GET" id="cert-search-form" class="flex gap-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-lms\resources\views/certificates/not-found.blade.php ENDPATH**/ ?>