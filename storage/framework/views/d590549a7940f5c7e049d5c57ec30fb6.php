...
Admin Home — <?php echo e(config('app.name')); ?>
    ...
    <section class="max-w-7xl mx-auto px-6 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <?php $__currentLoopData = $quickStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($stat['link']); ?>" class="block relative group">
                    ...
                    <div class="relative <?php echo e($stat['bg']); ?> rounded-2xl p-6 border border-white shadow-lg group-hover:scale-105 transition-transform">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-gray-600 text-xs font-semibold uppercase tracking-wide mb-1"><?php echo e($stat['label']); ?></p>
                                <p class="text-3xl font-black bg-gradient-to-r <?php echo e($stat['gradient']); ?> bg-clip-text text-transparent">
                                    <?php echo e($stat['value']); ?>

                                </p>
                            </div>
                            <div class="text-4xl"><?php echo e($stat['icon']); ?></div>
                        </div>
                    </div>
                </a>
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('admin.community.index')); ?>" class="text-sm font-bold text-indigo-600 hover:text-indigo-700 transition-colors">
                    Manage All Posts →
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <?php $__currentLoopData = $quickLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($link['link']); ?>" 
                       class="group relative overflow-hidden bg-gradient-to-r <?php echo e($link['gradient']); ?> rounded-2xl p-6 text-white shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300">
                        <div class="relative z-10 flex items-center justify-between">
                            <span class="text-lg font-bold"><?php echo e($link['label']); ?></span>
                            <span class="text-3xl"><?php echo e($link['icon']); ?></span>
                        </div>
