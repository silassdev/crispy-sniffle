    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-indigo-900 via-blue-900 to-indigo-800 text-white py-24 mb-16">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <h1 class="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 animate-fade-in-up">
                Build the <span class="text-blue-400">Ecosystem</span>
            </h1>
            ...
            <div class="flex justify-center gap-4">
                <a href="https://github.com/silassdev/crispy-sniffle" target="_blank" class="px-8 py-3 bg-white text-blue-900 font-bold rounded-full hover:bg-blue-50 transition duration-300 shadow-lg flex items-center gap-2">
                ...
                <a href="#become-mentor" class="px-8 py-3 bg-transparent border-2 border-white text-white font-bold rounded-full hover:bg-white hover:text-blue-900 transition duration-300">Become a Mentor</a>
            </div>
        </div>
    </div>
