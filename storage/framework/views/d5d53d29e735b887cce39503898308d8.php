                        ...
                        <?php $__currentLoopData = $certs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right flex justify-end gap-3">
                                    <a href="<?php echo e(route('certificate.public', $cert->certificate_number)); ?>" target="_blank" class="text-sky-600 hover:underline font-medium">
                                        View
                                    </a>
                                    <span class="text-slate-300">|</span>
                                    <a href="<?php echo e(route('certificates.pdf.preview', $cert->id)); ?>" target="_blank" class="text-slate-500 hover:text-slate-700">
                                        Preview PDF
                                    </a>
                                    <span class="text-slate-300">|</span>
