    ...
    <div class="flex items-center gap-3">
      <!--[if BLOCK]><![endif]--><?php if($q): ?>
        <div class="flex items-center gap-2 px-4 py-2 bg-blue-50 border border-blue-100 rounded-full">
            <span class="text-sm text-blue-600 font-bold">Search: "<?php echo e($q); ?>"</span>
        ...
        <!--[if BLOCK]><![endif]--><?php if($post->feature_image): ?>
          <div class="relative aspect-[16/10] overflow-hidden m-4 rounded-[2rem]">
              ...
              <div class="absolute top-4 left-4 flex flex-wrap gap-2">
                  <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $post->tags->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <button wire:click="$set('tag', '<?php echo e($t->slug); ?>')" 
        ...
        <div class="px-8 pb-8 pt-4 flex flex-col flex-1">
          ...
          <div class="pt-6 border-t border-gray-100 flex items-center justify-between mt-auto">
              <div class="flex gap-3">
                   <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $post->tags->slice(2, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <button wire:click="$set('tag','<?php echo e($t->slug); ?>')" 
