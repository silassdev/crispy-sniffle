                ...
                <table class="inner-table" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="cert-padding">
                            ...
                            <h1 class="cert-title text-gold"><?php echo e($typeTitle); ?></h1>
                            <p class="presented-to">This is proudly presented to</p>
                            
                            <!-- Name Section -->
                            <div class="student-name"><?php echo e($cert->student?->name ?? 'Student Name'); ?></div>
                            ...
                            <h3 class="course-name"><?php echo e($cert->course?->title ?? 'Course Program'); ?></h3>
                                        ...
                                        <table class="sig-table" width="100%">
                                            <tr>
                                                ...
                                                <td class="sig-column">
                                                    ...
                                                    <div class="sig-name"><?php echo e($cert->trainer?->name ?? 'James B'); ?></div>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table class="footer-info-table">
                                            <tr>
                                                <td align="left" class="footer-details-cell">
                                                    <div class="f-item"><span class="f-label">Certificate No:</span> <?php echo e($cert->certificate_number); ?></div>
                                                    <div class="f-item"><span class="f-label">Issued On:</span> <?php echo e($cert->issued_at?->format('F d, Y') ?? now()->format('F d, Y')); ?></div>
                                                </td>
                                                <td width="15"></td>
                                                <td class="qr-cell">
                                                    <div class="qr-box">
                                                        <img src="data:image/svg+xml;base64,<?php echo e($qrCode); ?>" width="80" height="80">
                                                    </div>
