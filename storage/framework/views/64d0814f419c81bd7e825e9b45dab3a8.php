<div class="space-y-4">
  ...
  <div class="flex items-center justify-between">
    <div>
      <h1 class="text-2xl font-semibold"><?php echo e($user->name); ?></h1>
      <div class="text-sm text-gray-500"><?php echo e($user->email); ?> • <?php echo e(ucfirst($user->role)); ?></div>
    </div>

    <div class="flex items-center gap-2">
      <!--[if BLOCK]><![endif]--><?php if($user->role === \App\Models\User::ROLE_ADMIN): ?>
        <button wire:click="sendPasswordReset" class="px-3 py-2 border rounded">Send reset</button>
      <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

      <!--[if BLOCK]><![endif]--><?php if($user->role === \App\Models\User::ROLE_TRAINER && ! $user->approved): ?>
    ...
    <div class="grid grid-cols-3 gap-6">
      <div class="col-span-1">
        ...
        <div class="mt-3 text-sm text-gray-600">
          <div><strong>Joined:</strong> <?php echo e($user->created_at->toDayDateTimeString()); ?></div>
          <div><strong>Last active:</strong> <?php echo e($user->last_active_at ?? '—'); ?></div>
          <div><strong>ID:</strong> <?php echo e($user->id); ?></div>
        </div>
      </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\laravel-lms\resources\views/livewire/admin/user-profile.blade.php ENDPATH**/ ?>