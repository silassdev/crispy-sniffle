      ...
      <div class="relative rounded-md p-4 bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 shadow-sm">
        <div class="flex items-start justify-between gap-3">
          <div class="flex items-center gap-3 min-w-0">
            ...
            <div class="min-w-0">
              <div class="text-sm text-slate-600 dark:text-slate-400 truncate"><?php echo e($card['label']); ?></div>
              <div class="text-xl font-bold text-slate-900 dark:text-white"><?php echo e($counters[$card['key']] ?? 0); ?></div>
            </div>
          </div>

          <div class="flex flex-col items-end">
            <div class="text-xs font-semibold <?php echo e($card['trendColor']); ?>"><?php echo e($card['trend']); ?></div>
            <div class="text-xs text-slate-500 dark:text-slate-400"><?php echo e($card['trendNote']); ?></div>
          </div>
        </div>
      </div>
