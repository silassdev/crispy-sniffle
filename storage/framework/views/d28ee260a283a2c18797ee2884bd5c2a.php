...
<body class="min-h-screen bg-gray-50 flex items-center justify-center p-6">
    <div class="max-w-4xl w-full bg-white rounded-xl shadow-2xl overflow-hidden">
        ...
        <div class="p-12 text-center">
            ...
            <h3 class="text-4xl font-bold text-gray-900 mb-6"><?php echo e($cert->student->name); ?></h3>
            
            <p class="text-lg text-gray-700 mb-8">
                For successfully completing the course:<br>
                <span class="font-semibold text-xl text-indigo-600 mt-2 block"><?php echo e($cert->course->title ?? 'General Achievement'); ?></span>
            </p>

            <?php if($cert->notes): ?>
                <div class="max-w-2xl mx-auto mb-8">
                    <p class="text-gray-600 italic text-sm"><?php echo e($cert->notes); ?></p>
                </div>
            <?php endif; ?>
            ...
            <div class="mt-12 pt-8 border-t border-gray-200 grid grid-cols-2 gap-8 text-sm text-gray-600">
                <div>
                    <p class="font-semibold text-gray-900"><?php echo e($cert->trainer->name); ?></p>
                    <p>Trainer</p>
                </div>
                <div>
                    <p class="font-semibold text-gray-900"><?php echo e($cert->issued_at ? $cert->issued_at->format('F d, Y') : ''); ?></p>
                    <p>Date Issued</p>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\laravel-lms\resources\views/certificates/public.blade.php ENDPATH**/ ?>