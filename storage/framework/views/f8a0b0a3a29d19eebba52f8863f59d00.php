...
<?php $__env->startSection('title', 'Application received'); ?>
  ...
  <div class="max-w-3xl mx-auto py-16 px-4">
    <div class="bg-white rounded shadow p-6 text-center">
      ...
      <?php if(session('trainer_email')): ?>
        <p class="text-gray-700">Thanks — your application for trainer account was received for <strong><?php echo e(session('trainer_email')); ?></strong>.</p>
      <?php else: ?>
