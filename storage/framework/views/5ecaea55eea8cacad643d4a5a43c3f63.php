                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p class="font-semibold text-gray-900"><?php echo e($selectedCert->certificate_number ?? 'Pending Assignment'); ?></p>
                                    </div>
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <div class="flex items-center gap-3">
                                            <div class="h-10 w-10 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center font-bold uppercase">
                                                <?php echo e(substr($selectedCert->student->name ?? 'U', 0, 1)); ?>

                                            </div>
                                            <div>
                                                <p class="font-semibold text-gray-900"><?php echo e($selectedCert->student->name ?? 'Unknown'); ?></p>
                                                <p class="text-sm text-gray-500"><?php echo e($selectedCert->student->email ?? ''); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p class="font-semibold text-gray-900"><?php echo e($selectedCert->course->title ?? '—'); ?></p>
                                    </div>

                                    <!-- Notes -->
                                    <!--[if BLOCK]><![endif]--><?php if($selectedCert->notes): ?>
                                        <div class="bg-gray-50 p-4 rounded-lg">
                                            <p class="text-sm text-gray-600 mb-1">Notes</p>
                                            <p class="text-gray-700"><?php echo e($selectedCert->notes); ?></p>
                                        </div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if(strtolower($selectedCert->status) === 'approved'): ?>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($selectedCert->issued_at): ?>
                                                <p class="text-xs text-gray-500 mt-2">Issued: <?php echo e($selectedCert->issued_at->format('M d, Y')); ?></p>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <?php elseif(strtolower($selectedCert->status) === 'rejected'): ?>
