    ...
    <div class="grid lg:grid-cols-2 gap-12 items-center">
      <div class="relative z-10" data-reveal>
        ...
        <div class="flex flex-wrap gap-4">
          ...
          <a href="{{ route('courses.index') }}" class="inline-flex items-center gap-2 px-8 py-4 border-2 border-slate-200 rounded-full font-semibold hover:bg-slate-50 hover:border-slate-300 transition-all duration-300" aria-label="Explore courses">
            Explore programs
          </a>
        </div>
