...
<div class="bg-gray-50 min-h-screen">
    ...
    <div class="relative overflow-hidden bg-slate-900 py-24 mb-16 group">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <div class="flex justify-center gap-4">
                ...
                <a href="{{ route('contact.show') }}" class="px-8 py-3 bg-transparent border-2 border-white/20 text-white font-bold rounded-full hover:bg-white/10 transition duration-300">Contact Us</a>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-24" id="tiers">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm hover:shadow-xl transition-shadow">
                ...
                <a href="{{ route('contact.show') }}" class="block text-center px-6 py-3 bg-gray-100 text-gray-800 font-bold rounded-xl hover:bg-gray-200 transition duration-300">Get Started</a>
            </div>
            ...
            <div class="bg-white border-2 border-indigo-500 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-shadow transform scale-105">
                ...
                <a href="{{ route('contact.show') }}" class="block text-center px-6 py-3 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 transition duration-300">Most Popular</a>
            </div>
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm hover:shadow-xl transition-shadow">
                ...
                <a href="{{ route('contact.show') }}" class="block text-center px-6 py-3 bg-gray-100 text-gray-800 font-bold rounded-xl hover:bg-gray-200 transition duration-300">Contact Us</a>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        <div class="bg-indigo-600 rounded-3xl p-12 text-center text-white shadow-2xl shadow-indigo-200">
            ...
            <a href="{{ route('contact.show') }}" class="inline-block px-10 py-4 bg-white text-indigo-600 font-bold rounded-xl hover:bg-indigo-50 transition duration-300 shadow-lg hover:-translate-y-1 transform">Contact the Team</a>
        </div>
    </div>
</div>
