    ...
    <div class="relative overflow-hidden bg-slate-900 py-24 mb-16 group">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <div class="flex justify-center gap-4">
                ...
                <a href="{{ route('contact.show') }}" class="px-8 py-3 bg-transparent border-2 border-white/20 text-white font-bold rounded-full hover:bg-white/10 transition duration-300">Contact Support</a>
            </div>
        </div>
    </div>
