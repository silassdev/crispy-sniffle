    ...
    <div class="mb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg p-4 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
          <h4 class="font-semibold text-gray-800 dark:text-gray-200 mb-2">{{ $course['name'] }}</h4>
          <div class="space-y-2">
            ...
            <div>
              ...
              <div class="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-2">
                <div class="bg-emerald-600 h-2 rounded-full" style="width: {{ $course['progress'] }}%"></div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="flex items-center justify-between">
              <div class="flex-1">
                <p class="text-sm text-gray-800 dark:text-gray-200">
                  ...
                  <span class="text-emerald-600 dark:text-emerald-400">{{ $activity['course'] }}</span>
                </p>
              </div>
              <span class="text-xs text-slate-500 dark:text-slate-400">{{ $activity['time'] }}</span>
            </div>
          </div>
          @endforeach
        </div>
