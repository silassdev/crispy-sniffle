                ...
                @forelse($courses as $course)
                    <tr class="hover:bg-gray-50/80 transition-colors duration-150">
                        <td class="px-6 py-4">
                            ...
                            <div class="text-xs text-gray-500 truncate max-w-xs">{{ Str::limit($course->description, 60) }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm font-semibold text-gray-900">${{ number_format($course->price, 2) }}</span>
                        </td>
