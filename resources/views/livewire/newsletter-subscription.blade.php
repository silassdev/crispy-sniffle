             ...
             <div class="relative z-10">
                <div class="text-center mb-8">
                    ...
                    <p class="text-slate-500 mt-2 text-sm leading-relaxed">
                        Hey <span class="text-emerald-600 font-semibold">{{ $email }}</span>! To make sure we send you relevant content, please select up to <span class="font-bold text-slate-900">5 topics</span> you're interested in.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-2 gap-3 mb-8">
                    @foreach($availableInterests as $key => $label)
                        <button wire:click="toggleInterest('{{ $key }}')"
                                ...
                                @if(count($interests) >= 5 && !in_array($key, $interests)) disabled @endif>
