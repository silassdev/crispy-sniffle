    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-indigo-900 via-blue-900 to-indigo-800 text-white py-24 mb-16">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <div class="flex justify-center gap-4">
                <a href="{{ route('blogs.index') }}" class="px-8 py-3 bg-white text-blue-900 font-bold rounded-full hover:bg-blue-50 transition duration-300 shadow-lg">Our Blog</a>
                <a href="{{ route('contact.show') }}" class="px-8 py-3 bg-transparent border-2 border-white text-white font-bold rounded-full hover:bg-white hover:text-blue-900 transition duration-300">Get in Touch</a>
            </div>
        </div>
    </div>
