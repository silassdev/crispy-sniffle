...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/app.css') }}"> <!-- Adjust if you have custom CSS -->
</head>
<body>
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="text-center">
            ...
            <a href="{{ url('/') }}" class="mt-6 inline-block px-6 py-3 bg-indigo-600 text-white text-lg font-medium rounded-lg hover:bg-indigo-700">
                Go Back to Home
            </a>
        </div>
    </div>
